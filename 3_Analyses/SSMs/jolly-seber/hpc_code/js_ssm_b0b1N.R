##### Description #####
# Overall script to run density-dependent (b0+b1N) jags models on the HPC
...
##### Define jags model for density dependent phi #####
sink(file = "/home/s4532001/7008_guppies/jags_models/js_ssm_b0b1N.jags")
cat("
  model {
...
JS_ssm <- function(CH, nt, nb, nc) {
  ...
  parameters <- c("psi", "p", "beta0", "beta1", "b", "Nsuper", "N", "B", "gamma")
  ...
  #                 model.file = "/home/s4532001/7008_guppies/jags_models/js_ssm_b0b1N.jags", 
...
js_ssm <- JS_ssm(river_data[[riv]][,1:5], nt = 1, nb = 5000, nc = 3)
save(js_ssm, file = 
       paste("/home/s4532001/7008_guppies/output/models/", rivers[riv], "_js_ssm_b0b1N.RData", sep = ""))
